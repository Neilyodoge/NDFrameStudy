    ...
    SubShader
    {
        ...
        // receive shadow
            ...
            // Distortion
                ...
                half depthDistortionTex = SAMPLE_TEXTURE2D(_CameraDepthTexture,sampler_CameraDepthTexture,saturate(opaqueUV + 1e-3)).r;  // 1e-3 为减少深度采样错误，也就是水上面物体边缘的采样错误
            ...
            // depthWater 扭曲
                ...
                // return half4(finalCaustic.rgb,1);    
