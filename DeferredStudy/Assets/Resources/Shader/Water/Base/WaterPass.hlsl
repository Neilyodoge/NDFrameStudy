...
Varyings vert(Attributes v)
{
    ...
    float VertexAnim = GerstnerWave(_WaveA, o.PositionWS, o.tangentWS, o.bitangentWS); // 这里有个问题,法线是贴图前的
...
half4 frag(Varyings i): SV_Target
{
    ...
    Tint += lerp(specular * _ShadowColor.a, specular, shadowPart);                                          // 加入高光部分,_ShadowColor.a控制“阴影内高光”强度
