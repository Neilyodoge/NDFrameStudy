...
Shader "PBR"
{
	Properties
	{
		...
		[ASEBegin]_Alebdo("Alebdo", 2D) = "white" {}
		_N("N", 2D) = "bump" {}
		_R("R", 2D) = "white" {}
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float2 uv_Alebdo = IN.ase_texcoord7.xy * _Alebdo_ST.xy + _Alebdo_ST.zw;
				float4 tex2DNode6 = tex2D( _Alebdo, uv_Alebdo );
				clip( tex2DNode6.a - _clip);
				
				float2 uv_N = IN.ase_texcoord7.xy * _N_ST.xy + _N_ST.zw;
				
				float2 uv_M = IN.ase_texcoord7.xy * _M_ST.xy + _M_ST.zw;
				
				float2 uv_R = IN.ase_texcoord7.xy * _R_ST.xy + _R_ST.zw;
				
				float2 uv_o = IN.ase_texcoord7.xy * _o_ST.xy + _o_ST.zw;
				
				float3 Albedo = tex2DNode6.rgb;
				float3 Normal = tex2D( _N, uv_N ).rgb;
				float3 Emission = 0;
				float3 Specular = 0.5;
				float Metallic = tex2D( _M, uv_M ).r;
				float Smoothness = ( _Float0 * ( 1.0 - tex2D( _R, uv_R ).r ) );
				float Occlusion = tex2D( _o, uv_o ).r;
				float Alpha = 1;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 uv_Alebdo = IN.ase_texcoord2.xy * _Alebdo_ST.xy + _Alebdo_ST.zw;
				float4 tex2DNode6 = tex2D( _Alebdo, uv_Alebdo );
				clip( tex2DNode6.a - _clip);
...
/*ASEBEGIN
Version=18500
2120.8;97.6;1803.2;993.4;1288.803;266.3001;1;True;True
Node;AmplifyShaderEditor.SamplerNode;6;-756.0003,-215.1001;Inherit;True;Property;_Alebdo;Alebdo;0;0;Create;True;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;15;-816.0026,-20.70007;Inherit;False;Property;_clip;clip;6;0;Create;True;0;0;False;0;False;0.5;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;7;-511.2,32.90005;Inherit;True;Property;_N;N;1;0;Create;True;0;0;False;0;False;-1;None;None;True;0;False;bump;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;9;-212.0004,324.9;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;10;-553.6004,273.7;Inherit;False;Property;_Float0;Float 0;3;0;Create;True;0;0;False;0;False;0.5;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;8;-700.0004,366.4999;Inherit;True;Property;_R;R;2;0;Create;True;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.OneMinusNode;11;-387.2008,392.1;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;12;-515.2023,616.9;Inherit;True;Property;_o;o;4;0;Create;True;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;13;-876.8026,128.9;Inherit;True;Property;_M;M;5;0;Create;True;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ClipNode;14;-277.6027,-105.5001;Inherit;False;3;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=DD90BA49E3862A95EE0D901DC5CD0B67C57B543F